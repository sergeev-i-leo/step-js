...
class ThemesSwitch extends Dropdown {
  ...
  mount() {
    const dropdownToggle = new Dropdown.Toggle("button", undefined, "navbar-toggler d-flex align-items-center px-3", this);
    ...
    const dropdownMenu = new Dropdown.Menu("app-router-dropdown-menu", this);
